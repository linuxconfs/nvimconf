...
map("n", "gt", "<cmd>GoTestFunc -v<CR>", { noremap = true, silent = true })
map("n", "gi", "<cmd>GoImports<CR>", { noremap = true, silent = true })
map("n", "g<S-s>", "<cmd>GoStop<CR>", { noremap = true, silent = true })
